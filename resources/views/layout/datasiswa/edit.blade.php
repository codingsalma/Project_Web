    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <form action="{{route('datasiswa.update', $data[0]->id_siswa)}}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            <label for="nama">NIS</label>
                            <input type="text" class="form-control" name="nis" value="{{$data[0]->nis}}">
                        </div>
                        <div class="form-group">
                            <label for="nama">Nama Siswa</label>
                            <input type="text" class="form-control" name="nama" value="{{$data[0]->nama_siswa}}">
                        </div>
                        <div class="form-group">
